      ...
      for (final mosque in remoteMosques) {
        await _database.into(_database.mosques).insertOnConflictUpdate(
              MosquesCompanion.insert(
                ...
                sourceUrl: Value(mosque.sourceUrl?.toString()),
                sourceStatus: Value(mosque.sourceStatus),
                verifiedAt: Value(mosque.verifiedAt),
                latitude: Value(mosque.latitude),
                longitude: Value(mosque.longitude),
                postcode: Value(mosque.postcode),
                addressLine: Value(mosque.addressLine),
                womensFacilities: Value(mosque.womensFacilities),
                wheelchairAccess: Value(mosque.wheelchairAccess),
                parking: Value(mosque.parking),
                contactEmail: Value(mosque.contactEmail),
                contactPhone: Value(mosque.contactPhone),
                lastScrapeError: Value(mosque.lastScrapeError),
